    ...
    <div id="about" className="section about-section">
      ...
      <div className="about-container reveal">
        ...
        <div className="about-text">
          ...
          <p>Hi, my name is Khoi Vi, a 4th-year Computer Science student at Vietnamese-German University (VGU) on a mission to become a Full-Stack Developer. For me, coding is all about connecting solid logic with a seamless user experience. I sharpened my problem-solving foundations with C/C++, Python, and Java (OOP), and now I bring that rigor to the full stack: crafting responsive, pixel-precise interfaces in React and architecting reliable RESTful APIs and server-side logic in Node.js. My goal is simple — build products that run flawlessly and feel effortless to use.</p>
          <p>My mindset was greatly shaped by a 6-month study abroad program in Bonn, Germany, which leveled up both my technical skills and my ability to collaborate in cross-cultural teams. Currently, I'm diving deep into AI — exploring Generative AI and Agentic AI to understand how modern models reason, generate, and act, with the goal of building intelligent products that deliver real value!</p>
        </div>
